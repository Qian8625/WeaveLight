...
- SmallObjectDetection: Detect small remote-sensing objects and return horizontal bounding boxes, labels, and confidences. It is suitable for dense small targets and large images; `text` only filters within the supported class set, not open-vocabulary search. Example: {"name":"SmallObjectDetection","arguments":{"image":"img_1","text":"ship"}}
