...
- AddDEMLayer: Fetches a DEM from Google Earth Engine for the current GeoPackage AOI, uses it to create contour and elevation-band layers, and reports elevation statistics. Example: {"name":"AddDEMLayer","arguments":{"gpkg":"gpkg_1","contour_interval_m":20,"band_step_m":100}}
